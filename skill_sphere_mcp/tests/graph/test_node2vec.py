...
async def test_get_graph(
    ...
    # Setup mock result
    test_mock_result.__aiter__.return_value = [
...
def test_get_embedding(test_node2vec: Node2Vec) -> None:
    ...
    node_id = "1"
    embedding = np.random.rand(test_node2vec.dimension)
...
def test_get_all_embeddings(test_node2vec: Node2Vec) -> None:
    ...
    embeddings = {
        "1": np.random.rand(test_node2vec.dimension),
        "2": np.random.rand(test_node2vec.dimension),
    }
